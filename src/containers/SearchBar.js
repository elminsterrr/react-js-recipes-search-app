...
class SearchBar extends Component {
  ...
  buttonsView () {
    ...
    if ((this.props.error) ||
      ((this.props.currentSearchFromStore !== null) && (this.props.checkIfSomeDataWasFound))) {
      return (
        <div>
          <div className="buttons">
            <button className="btn btn-secondary" onClick={this.handlePrev}>Prev Page</button>
            <span className="page-numbers">{this.state.page}</span>
            <button className="btn btn-secondary" onClick={this.handleNext}>Next Page</button>
          </div>
          <div className="fav-button-search-bar">
            <button onClick={this.handleShowHideFavorites}>{this.state.fav} Favorites</button>
          </div>
        </div>
      )
    }
    ...
    return (
      <div>
        <form onSubmit={this.handleSubmit} className="input-group">
          ...
          />
          <ButtonSearch className="btn btn-secondary submit">Search</ButtonSearch>
        </form>
